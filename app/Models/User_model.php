...
class User_model extends Model
{
    ...
    {
        $sql = "UPDATE user_register SET first_name = '$user_name',email = '$user_email_address',picture = '$user_image' WHERE email = '$user_email_address' AND user_login_type = 'facebook' ";
        $this->connect_postgresdb->execute($sql); //จะทำการ update ข้อมูล facebook เข้า ฐานข้อมูล
    }
    ...
    {
        $sql = "UPDATE user_register SET role_id = '2' WHERE email = '$Email' AND user_login_type = '$Type' ";
    ...
    {
        $sql = "UPDATE user_register SET first_name = '$Full_name' WHERE email = '$Email' AND user_login_type = 'normal' ";
        $this->connect_postgresdb->execute($sql);
        return true;
    }
    /**
    ...
    {
        $sql = "UPDATE user_register SET picture = '$Photo_Type' WHERE email = '$Email' AND user_login_type = '$Type' ";
        $this->connect_postgresdb->execute($sql);
        return true;
    }
    /**
    ...
    {
        $sql = "UPDATE user_register SET password = '$Password_New' WHERE email = '$Email' AND user_login_type = 'normal' ";
        $this->connect_postgresdb->execute($sql);
    }
    /**
